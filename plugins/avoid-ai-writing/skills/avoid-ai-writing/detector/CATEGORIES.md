...
| `emotional-flatline` | Emotional flatline | Emotional flatline / Superficial -ing analyses *(style-only for authorship scoring: targeted #82 corpus run found zero hits in both classes; detector weight 0 pending evidence)* |
